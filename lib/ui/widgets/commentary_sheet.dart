    ...
    return Padding(
      ...
      child: ClipRRect(
        ...
        child: BackdropFilter(
          ...
          child: Container(
            // Ensure we take full width available to us in the modal
            width: double.infinity,
            decoration: BoxDecoration(
              color: isDark
            ...
            child: SafeArea(
              ...
              // This prevents double-padding if MediaQuery has injected rail width.
              left: railOffset == 0,
              top: false,
              right: true,
              bottom: true,
              // No internal minimum padding needed now, the box itself is moved
              child: Column(
                mainAxisSize: MainAxisSize.min,
